...
parser.add_argument("--data_dir", default="/data/VoComni", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./VoComni.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/VoComni', type=str, help="cache_dir")
