...
def get_loader(args):
    ...
    json = args.json_list
    train_list = load_decathlon_datalist(json, True, "training", base_dir=data_dir)
    unlabel_list = load_decathlon_datalist(json, True, "unlabeled", base_dir=data_dir)
    val_list = load_decathlon_datalist(json, True, "validation", base_dir=data_dir)
    ...
    train_list = train_list + unlabel_list
