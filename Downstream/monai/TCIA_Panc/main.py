...
parser.add_argument("--data_dir", default="/data/Dataset082_TCIA_Pancreas-CT", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./tcia_panc.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/tcia_panc', type=str, help="dataset json file")
