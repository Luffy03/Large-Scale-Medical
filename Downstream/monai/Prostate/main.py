...
parser.add_argument("--data_dir", default="/data/Dataset005_Prostate", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/data/cache/Prostate/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./Prostate.json", type=str, help="dataset json file")
