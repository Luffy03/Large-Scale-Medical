...
parser.add_argument("--data_dir", default="/data/Dataset192_BHSD/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./BHSD.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/BHSD', type=str, help="dataset json file")
