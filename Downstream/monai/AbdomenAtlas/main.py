...
roi = 96
parser.add_argument("--data_dir", default="/data/AbdomenAtlasMini1.0/", type=str,
...
parser.add_argument("--dataset_train_list", default='AbdomenAtlas1.0_train.txt', help="dataset json file")
parser.add_argument("--dataset_val_list", default='AbdomenAtlas1.0_val.txt', help="dataset json file")
parser.add_argument("--cache_dataset", default=True, help="use monai CACHE Dataset class")
parser.add_argument("--cache_dir", default='/data/cache/Atlas', help="CACHE dir")
...
parser.add_argument("--pos", default=9, type=int, help="number of positive sample")
