...
parser.add_argument("--data_dir", default="/data/MM-WHS/mr_train", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/data/cache/MM-WHS-MRI/", type=str, help="dataset directory")
