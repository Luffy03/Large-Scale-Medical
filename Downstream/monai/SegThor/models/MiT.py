...
import models.MiT_encoder as MiT_encoder
from models.MiT_utils import trunc_normal_
...
class MiT(nn.Module):
    ...
    def __init__(self, norm_cfg='BN', activation_cfg='ReLU', weight_std=False, img_size=[96, 96, 96], num_classes=2, in_chans=1,
                 embed_dims = [256, 128, 48, 32], num_heads = [8, 4, 2], mlp_ratios = [4, 4, 4], qkv_bias=False, qk_scale=None,
                 drop_rate=0., attn_drop_rate=0., drop_path_rate=0., norm_layer=nn.LayerNorm, depths = [3, 4, 3],
