...
parser.add_argument("--data_dir", default="/data/Segthor/", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default='/data/cache/Segthor', type=str, help="dataset json file")
parser.add_argument("--json_list", default="./dataset_segthor.json", type=str, help="dataset json file")
