...
parser.add_argument("--data_dir", default="/data/Dataset360_abdomen1k", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/data/cache/Dataset360_abdomen1k", type=str, help="dataset directory")
parser.add_argument("--json_list", default="dataset_abdomen1k.json", type=str, help="dataset json file")
...
parser.add_argument("--val_every", default=1000, type=int, help="validation frequency")
