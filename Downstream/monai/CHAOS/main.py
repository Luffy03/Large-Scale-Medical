...
parser.add_argument("--data_dir", default="/data/CHAOS", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./chaos.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/CHAOS', type=str, help="dataset json file")
