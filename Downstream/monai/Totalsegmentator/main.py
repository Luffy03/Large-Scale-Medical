...
parser.add_argument("--data_dir", default="/data/Dataset606_Totalsegmentator/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./Totalsegmentator.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/Totalsegmentator', type=str, help="dataset json file")
