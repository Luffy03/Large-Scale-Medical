...
parser.add_argument("--data_dir", default="/data/CC-CCII_public/data/", type=str, help="dataset directory")
...
def main_worker(gpu, args):
    ...
    if args.use_ssl_pretrained:
        model_dict = torch.load(os.path.join(args.pretrained_root, args.pretrained_path), map_location=torch.device('cpu'))
