...
parser.add_argument("--data_dir", default="/data/Dataset008_HepaticVessel/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./vessel.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/vessel', type=str, help="dataset json file")
