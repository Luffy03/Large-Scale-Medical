...
parser.add_argument("--data_dir", default="/data/Dataset219_AMOS2022_postChallenge_task2", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/data/cache/AMOS_MRI/", type=str, help="dataset directory")
