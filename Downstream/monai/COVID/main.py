...
parser.add_argument("--data_dir", default="/data/Covid19_20/Train", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default='/data/cache/covid', type=str, help="dataset directory")
