...
parser.add_argument("--data_dir", default="/data/Dataset500_PANORAMA/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./PANORAMA.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/PANORAMA', type=str, help="dataset json file")
