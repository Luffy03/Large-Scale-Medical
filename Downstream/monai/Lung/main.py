...
parser.add_argument("--data_dir", default="/data/Dataset006_Lung/", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/data/cache/Lung/", type=str, help="cache directory")
parser.add_argument("--json_list", default="./dataset_MSD_Lung.json", type=str, help="dataset json file")
