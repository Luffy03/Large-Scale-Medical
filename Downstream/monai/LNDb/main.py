...
parser.add_argument("--data_dir", default="/data/LNDb/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./LNDb.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/LNDb', type=str, help="dataset json file")
