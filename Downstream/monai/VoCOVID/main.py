...
parser.add_argument("--data_dir", default="/data/VoCovid", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./VoCovid.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default="/data/cache/vocovid", type=str, help="dataset directory")
