...
parser.add_argument("--data_dir", default="/data/Dataset220_KiTS2023/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./dataset_kits.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/kits', type=str, help="dataset json file")
