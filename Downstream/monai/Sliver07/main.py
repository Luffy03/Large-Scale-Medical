...
parser.add_argument("--data_dir", default="/data/SLIVER07", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./SLIVER07.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/SLIVER07', type=str, help="dataset json file")
