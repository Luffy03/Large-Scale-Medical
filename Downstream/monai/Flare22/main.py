...
parser.add_argument("--data_dir", default="/data/Flare22/", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default='/data/cache/flare22', type=str, help="dataset directory")
