...
parser.add_argument("--data_dir", default="/data/Task01_BrainTumour/", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/data/cache/BRATS/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./brats.json", type=str, help="dataset json file")
