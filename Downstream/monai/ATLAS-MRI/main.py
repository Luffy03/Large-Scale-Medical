...
parser.add_argument("--pretrained_root", default='/home/linshan/pretrained/', help="pre-trained root")

parser.add_argument("--checkpoint", default=None, help="start training from saved checkpoint")
parser.add_argument("--logdir", default="logs", type=str, help="directory to save the tensorboard logs")

parser.add_argument("--data_dir", default="/data/ATLAS-MRI", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/data/cache/ATLAS-MRI/", type=str, help="dataset directory")
