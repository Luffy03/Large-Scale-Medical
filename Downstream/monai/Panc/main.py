...
parser.add_argument("--data_dir", default="/data/Dataset007_Pancreas/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./dataset_panc.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/panc', type=str, help="dataset json file")
