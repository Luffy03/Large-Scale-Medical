...
parser.add_argument("--data_dir", default="/data/Dataset200_Kipa22/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./kipa.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/kipa', type=str, help="dataset json file")
...
parser.add_argument("--a_min", default=900.0, type=float, help="a_min in ScaleIntensityRanged")
parser.add_argument("--a_max", default=1400.0, type=float, help="a_max in ScaleIntensityRanged")
