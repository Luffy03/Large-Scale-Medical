...
parser.add_argument("--data_dir", default="/data/Dataset004_Hippocampus", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/data/cache/Hip/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./Hip.json", type=str, help="dataset json file")
