...
parser.add_argument("--data_dir", default="/data/Dataset190_Structseg19/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./Structseg.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/Structseg', type=str, help="dataset json file")
...
parser.add_argument("--out_channels", default=23, type=int, help="number of output channels")

parser.add_argument("--a_min", default=-600.0, type=float, help="a_min in ScaleIntensityRanged")
