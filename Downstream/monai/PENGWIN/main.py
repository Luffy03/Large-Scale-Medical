...
parser.add_argument("--data_dir", default="/data/PENGWIN/", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/data/cache/PENGWIN/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./PENGWIN.json", type=str, help="dataset json file")
...
parser.add_argument("--out_channels", default=31, type=int, help="number of output channels")
...
def main_worker(gpu, args):
    ...
    if args.use_ssl_pretrained:
        try:
            ...
            model_dict = torch.load("/home/linshan/SwinUNETR/model_0.8629.pt",
                                    map_location=torch.device('cpu'))
            state_dict = model_dict["state_dict"]
            for key in list(state_dict.keys()):
                state_dict[key.replace("out", "bad")] = state_dict.pop(key)
