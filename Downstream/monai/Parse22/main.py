...
parser.add_argument("--data_dir", default="/data/Parse22/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./Parse22.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/Parse22', type=str, help="dataset json file")
