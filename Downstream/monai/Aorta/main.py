...
parser.add_argument("--data_dir", default="/data/aorta", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./aorta.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/aorta', type=str, help="dataset json file")
