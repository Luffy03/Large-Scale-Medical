...
parser.add_argument("--data_dir", default="/data/ASOCA", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./ASOCA.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/ASOCA', type=str, help="dataset json file")
...
parser.add_argument("--a_max", default=600.0, type=float, help="a_max in ScaleIntensityRanged")
