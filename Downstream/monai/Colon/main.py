...
parser.add_argument("--data_dir", default="/data/Dataset010_Colon/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./colon.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/colon', type=str, help="dataset json file")
