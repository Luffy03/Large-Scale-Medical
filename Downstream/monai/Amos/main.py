...
parser.add_argument("--data_dir", default="/data/Amos2022/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="dataset_CT.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/amos', type=str, help="dataset json file")
