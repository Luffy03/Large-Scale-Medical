...
from models.SwinTransformer import Swin
...
def main():
    batch_size = 1
    train_dir = '/data/linshan/registration/OASIS_L2R_2021_task03/All/'
    val_dir = '/data/linshan/registration/OASIS_L2R_2021_task03/Test/'
    weights = [1, 1, 1] # loss weights
    save_dir = 'VoCo_pre_Swin_ncc_{}_dsc{}_diffusion_{}/'.format(weights[0], weights[1], weights[2])
    ...
    Initialize model
    '''
    model = Swin(input_channels=2)
    model_dict = torch.load("/home/linshan/SwinUNETR/model_B.pt", map_location=torch.device('cpu'))
