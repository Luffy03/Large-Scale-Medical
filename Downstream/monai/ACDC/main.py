...
parser.add_argument("--data_dir", default="/data/Dataset027_ACDC", type=str, help="dataset directory")
parser.add_argument("--cache_dir", default="/data/cache/ACDC/", type=str, help="dataset directory")
