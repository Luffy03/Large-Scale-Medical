...
parser.add_argument("--data_dir", default="/data/Dataset009_Spleen/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./spleen.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/spleen', type=str, help="dataset json file")
