...
parser.add_argument("--data_dir", default="/data/FUMPE/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./FUMPE.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/FUMPE', type=str, help="dataset json file")
