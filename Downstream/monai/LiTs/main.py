...
parser.add_argument("--data_dir", default="/data/Dataset003_Liver/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./dataset_lits.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/lits', type=str, help="dataset json file")
