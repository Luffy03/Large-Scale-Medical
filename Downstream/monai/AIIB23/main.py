...
parser.add_argument("--data_dir", default="/data/AIIB23/", type=str, help="dataset directory")
parser.add_argument("--json_list", default="./AIIB23.json", type=str, help="dataset json file")
parser.add_argument("--cache_dir", default='/data/cache/AIIB23', type=str, help="dataset json file")
